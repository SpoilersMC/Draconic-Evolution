...
public class GUIParticleGenerator extends GuiScreen {
    ...
    private static final String[] infoText = {
            ...
            EnumChatFormatting.DARK_RED + StringEscapeUtils.unescapeJava(StatCollector.translateToLocal("gui.de.particleGenerator.info.5.title"))
                + EnumChatFormatting.BLACK + StringEscapeUtils.unescapeJava(StatCollector.translateToLocal("gui.de.particleGenerator.info.5")),
            EnumChatFormatting.DARK_RED + StringEscapeUtils.unescapeJava(StatCollector.translateToLocal("gui.de.particleGenerator.info.6.title"))
                + EnumChatFormatting.BLACK + StringEscapeUtils.unescapeJava(StatCollector.translateToLocal("gui.de.particleGenerator.info.6")),
    ...
    public void drawScreen(int x, int y, float partialTicks) {
        ...
        if(page == 1) {
            fontRendererObj.drawStringWithShadow(StatCollector.translateToLocal("gui.de.particleGenerator.main.title"), posX + 60, posY + 5, 0x00FFFF);
        ...
        if(page == 3) {
            fontRendererObj.drawStringWithShadow(StatCollector.translateToLocal("gui.de.particleGenerator.beam.title"), posX + 65, posY + 5, 0x00FFFF);
            for(int row = 0; row < 8; row++) {
        ...
        if(page == 10) {
            fontRendererObj.drawStringWithShadow(StatCollector.translateToLocal("gui.de.particleGenerator.info.title"), posX + 75, posY + 5, 0x00FFFF);
            fontRendererObj.drawSplitString(infoText[infoPage], posX + 5, posY + 20, 200, 0x000000);
            fontRendererObj.drawSplitString(StatCollector.translateToLocalFormatted("gui.de.particleGenerator.page.name", infoPage + 1),posX + 88, posY + 180, 200, 0xFF0000);
        }
        fontRendererObj.drawStringWithShadow(StatCollector.translateToLocal("gui.de.particleGenerator.hold.name"), posX + 215, posY + 11, 0xFFFFFF);
    ...
    public void initGui() {
        ...
        buttonList.add(showInfo = new GuiButton(102, posX - 21, posY + 3, 20, 20, StatCollector.translateToLocal("gui.de.particleGenerator.info.name")));
        buttonList.add(hideInfo = new GuiButton(103, posX - 31, posY + 23, 30, 20, StatCollector.translateToLocal("gui.de.particleGenerator.back.name")));
        ...
        buttonList.add(collisionToggle = new GuiButton(110, posX + 105, posY + 19 + 3 * 22, 102, 20, StatCollector.translateToLocal("gui.de.particleGenerator.blockCollision.name")));
        buttonList.add(particleSelector = new GuiButton(111, posX + 105, posY + 19 + 4 * 22, 102, 20, StatCollector.translateToLocal("gui.de.particleGenerator.particleSelected.name")));
        buttonList.add(particleToggle = new GuiButton(112, posX + 105, posY + 19 + 5 * 22, 102, 20, StatCollector.translateToLocal("gui.de.particleGenerator.enabled.name")));
        ...
        buttonList.add(beamToggle = new GuiButton(120, posX + 105, posY + 19, 102, 20, StatCollector.translateToLocal("gui.de.particleGenerator.enabled.name")));
        buttonList.add(coreRenderToggle = new GuiButton(121, posX + 105, posY + 41, 102, 20, StatCollector.translateToLocal("gui.de.particleGenerator.renderCore.name")));
        buttonList.add(settingsSaver = new GuiButton(127, posX + 105, posY + 19 + 7 * 22, 102, 20, StatCollector.translateToLocal("gui.de.particleGenerator.saveSettings.name")));
    ...
    protected void actionPerformed(GuiButton button) {
        ...
        case 110:
            ...
            break;
        case 111:
            selectedParticle = selectedParticle < TileParticleGenerator.MAXIMUM_PARTICLE_INDEX ? selectedParticle + 1 : 1;
        ...
        updateButtons();
        DraconicEvolution.network.sendToServer(new ParticleGenPacket((byte)button.id, packetData, particleGenerator.xCoord, particleGenerator.yCoord, particleGenerator.zCoord));
    }
    ...
    private void modifyProperty(int propertyId, boolean shouldIncrease) {
        ...
        DraconicEvolution.network.sendToServer(new ParticleGenPacket((byte)propertyId, property.getSyncValue(), particleGenerator.xCoord, particleGenerator.yCoord, particleGenerator.zCoord));
    }
    ...
    private void updateButtons() {
        ...
        collisionToggle.displayString = StatCollector.translateToLocalFormatted("gui.de.particleGenerator.blockCollision.name", canParticleCollide ? onLabel : offLabel);
        particleSelector.visible = page == 2;
        particleSelector.displayString = StatCollector.translateToLocalFormatted("gui.de.particleGenerator.particleSelected.name", selectedParticle);
        particleToggle.visible = page == 2;
        particleToggle.displayString = StatCollector.translateToLocalFormatted("gui.de.particleGenerator.enabled.name", isParticlesEnabled ? onLabel : offLabel);
        beamToggle.visible = page == 3;
        beamToggle.displayString = StatCollector.translateToLocalFormatted("gui.de.particleGenerator.enabled.name", isBeamEnabled ? onLabel : offLabel);
        coreRenderToggle.visible = page == 3;
        coreRenderToggle.displayString = StatCollector.translateToLocalFormatted("gui.de.particleGenerator.renderCore.name", shouldRenderCore ? onLabel : offLabel);
